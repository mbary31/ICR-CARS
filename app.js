...
/* === ICR PATCH (minimal, no layout change) ===
   - Ensure 'Ver ficha' navigates (prevent overlay intercept): stopPropagation on click
   - Lightbox: X / backdrop / ESC closes (only if lightbox markup exists)
*/
